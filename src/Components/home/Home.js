        ...
        <div className="details">
          ...
          <div className="m-5 d-flex justify-content-center flex-column">
            ...
            <div className="home-buttons ml-2 d-flex justify-content-center">
              <a
                href="https://drive.google.com/file/d/1fkrnaoiQUsODuIVH1XjVHbtc0MA3v9-L/view?usp=sharing"
                className="btn primary-btn"
                rel="noreferrer"
                target="_blank"
              >
                <button className="btn text-white resume-btn blue ">
                  Get Resume{" "}
                </button>
              </a>
            ...
            <div className="col d-flex d-flex justify-content-center">
              <a
                className="mx-4 "
                href="https://www.linkedin.com/in/harsh-joshi-a87454198/"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                href="https://github.com/HarshJoshi123"
                target="_blank"
                rel="noreferrer"
              >
